      ...
      <div className={styles.authLayout}>
        <section className={styles.heroPanel}>
          ...
          <div className={styles.heroCard}>
            ...
            <h1 className={styles.heroTitle}>Step back into your secure flow.</h1>
            <p className={styles.heroSubtitle}>
              Log in to continue with a premium product experience built for
              clarity, security, and trust.
            </p>
            <div className={styles.heroChipRow}>
              <span className={styles.heroChip}>Modern Access</span>
              <span className={styles.heroChip}>Fast Recovery</span>
              <span className={styles.heroChip}>Professional UI</span>
            </div>
          </div>
        </section>
          ...
          <div className={styles.formCard}>
            <div className={styles.formHeader}>
              ...
              <p className={styles.formSubtitle}>
                Please enter your details to sign in to FLOWLENS.
              </p>
            </div>
            ...
            <form>
              ...
              <div className={loginStyles.helperRow}>
                <label className={loginStyles.remember}>
                  <input type="checkbox" />
                  Keep me logged in
                </label>
                <Link className={loginStyles.linkText} href="/forgot">
                  Forgot password?
                </Link>
              </div>
