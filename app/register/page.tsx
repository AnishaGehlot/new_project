      ...
      <div className={styles.authLayout}>
        <section className={styles.heroPanel}>
          ...
          <div className={styles.heroCard}>
            <p className={styles.heroEyebrow}>Join Us</p>
            <h1 className={styles.heroTitle}>Create your secure account.</h1>
            <p className={styles.heroSubtitle}>
              Register to unlock premium fraud-monitoring features and secure
              your digital presence.
            </p>
            <div className={styles.heroChipRow}>
              <span className={styles.heroChip}>Quick Setup</span>
              <span className={styles.heroChip}>Secure</span>
              <span className={styles.heroChip}>Professional</span>
            </div>
          </div>
        </section>
          ...
          <div className={styles.formCard}>
            <div className={styles.formHeader}>
              ...
              <p className={styles.formSubtitle}>
                Create your FLOWLENS account to get started.
              </p>
            </div>

            <form>
              <div className={registerStyles.formGrid2}>
                <div className={loginStyles.inputGroup}>
                  <label className={loginStyles.inputLabel}>First Name</label>
                ...
                <div className={loginStyles.inputGroup}>
                  <label className={loginStyles.inputLabel}>Last Name</label>
                  <div className={loginStyles.inputWrap}>
                    <input
                      className={loginStyles.textInput}
                      type="text"
